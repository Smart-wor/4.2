...
<html lang="en">
  ...
  <head>
    ...
    <title>Swahili food - Restaurant HTML Template</title>
<!--
...
-->
    ...
    <div class="outer-div">
    <div style="width:400px;"  id="top" class="container">
    ...
    <form action="{{url('orderconfirm')}}" method="post">
      ...
      <tr>
        ...
        <td class="col-md-4 px-0"><img src="/foodimage/{{$data->image}}" class="img-fluid" style="width:50px"></td>
      </tr>
      @endforeach
    ...
    <div id="appear" class="input-div" style="display:none" >
    <div>
        <label>Name</label>
    ...
    <div>
        <input  id="order" class="btn btn-warning"type="submit" value="Confirm Order" style="color: black">
